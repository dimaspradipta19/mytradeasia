  ...
  factory DetailProductModel.fromJson(Map<String, dynamic> json) =>
      DetailProductModel(
        ...
        detailProduct: json["detail_product"] != null
            ? DetailProduct.fromJson(json["detail_product"])
            : null,
        listIndustry: List<ListIndustry>.from(
            json["list-industry"].map((x) => ListIndustry.fromJson(x))),
        listCategory: List<ListCategory>.from(
            json["list-category"].map((x) => ListCategory.fromJson(x))),
        relatedProducts: List<RelatedProduct>.from(
            json["related-products"].map((x) => RelatedProduct.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "detail_product": detailProduct?.toJson(),
        "list-industry":
            List<dynamic>.from(listIndustry.map((x) => x.toJson())),
        "list-category":
