...
const Color greyColor4 = Color(0XFFF6F6F6);
...
const Color trackingDocMuda = Color(0XFFFBA953);
const Color trackingDocTua = Color(0XFFFFCC7A);

const Color trackingShipMuda = Color(0XFFE96864);
const Color trackingShipTua = Color(0XFFF48B88);
